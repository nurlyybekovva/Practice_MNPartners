...
const contactLinks = [
    ...
    { icon: <LocationOnIcon fontSize="small" />, text: 'Address of the company' },
]
                        ...
                        <Box>
                            ...
                            <Stack spacing={1}>
                                {companyLinks.map((link) => (
                                    <Link key={link.label} href={link.href} color="inherit" underline="none" sx={{ fontSize: 14, transition: 'color 0.2s', '&:hover': { color: '#7DA0CA' }, }}>
                                        {link.label}
                                    </Link>
                                ))}
                            </Stack>
